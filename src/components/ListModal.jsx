...
// nft prop shape: { tokenId, name, image, collection, contract }
        ...
        <div className="p-6 space-y-5">
          ...
          {nft && (
            <div className="flex items-center gap-4 p-4 rounded-xl"
              ...
              <div className="w-14 h-14 rounded-xl flex-shrink-0 overflow-hidden" style={{ background: "#161d28" }}>
                {nft.image && <img src={nft.image} alt={nft.name} className="w-full h-full object-cover" />}
              </div>
              <div>
                <div className="text-xs mb-0.5" style={{ color: "#9da7b3" }}>{nft.collection}</div>
          ...
          {/* Price input */}
          <div>
            <label className="block text-xs font-semibold uppercase tracking-wide mb-2" style={{ color: "#9da7b3" }}>
              Price (USD)
            </label>
            <div className="relative">
              ...
              <span className="absolute right-4 top-1/2 -translate-y-1/2 text-sm font-bold" style={{ color: "#9da7b3" }}>
                USD
              </span>
            </div>
          </div>
