...
export default async function handler(req, res) {
  ...
  try {
    ...
    // FORCE DEEP SCAN: If never synced, look back to block 0 to find your 33 NFTs
    ...
    // 1. OWNERSHIP SYNC (Finds your 33 NFTs)
    ...
    return res.status(200).json({ ok: true, synced: syncedCount, block: latestBlock.toString() });
  } catch (err) {
